class NomenclaturaRails < ActiveRecord::Migration[7.0]
  def change
    ...
    rename_column :sivel2_gen_caso_categoria_presponsable, 
      :id_categoria, :categoria_id
    rename_column :sivel2_gen_caso_categoria_presponsable, 
      :id_caso_presponsable, :caso_presponsable_id
    ...
    rename_column :sivel2_gen_antecedente_combatiente, 
      :id_combatiente, :combatiente_id
    rename_column :sivel2_gen_antecedente_combatiente, 
      :id_antecedente, :antecedente_id

    rename_column :sivel2_gen_antecedente_victima, 
      :id_antecedente, :antecedente_id
    rename_column :sivel2_gen_antecedente_victima, 
      :id_victima, :victima_id

    rename_column :sivel2_gen_antecedente_victimacolectiva, 
      :id_antecedente, :antecedente_id
    ...
    rename_column :sivel2_gen_organizacion_victimacolectiva, 
      :id_organizacion, :organizacion_id

    rename_column :sivel2_gen_profesion_victimacolectiva, 
      :id_profesion, :profesion_id

     rename_column :sivel2_gen_rangoedad_victimacolectiva, 
      :id_rangoedad, :rangoedad_id

     rename_column :sivel2_gen_sectorsocial_victimacolectiva, 
      :id_sectorsocial, :sectorsocial_id
