  ...
  def up
   execute <<-SQL
     ALTER TABLE sivel2_gen_comunidad_filiacion 
      RENAME TO sivel2_gen_filiacion_victimacolectiva;

     ALTER TABLE sivel2_gen_filiacion_victimacolectiva 
      ADD COLUMN victimacolectiva_id
        INTEGER REFERENCES sivel2_gen_victimacolectiva(id);

    UPDATE sivel2_gen_filiacion_victimacolectiva SET 
      victimacolectiva_id=sivel2_gen_victimacolectiva.id 
      FROM sivel2_gen_victimacolectiva WHERE 
        sivel2_gen_filiacion_victimacolectiva.id_grupoper=sivel2_gen_victimacolectiva.id_grupoper
      AND sivel2_gen_filiacion_victimacolectiva.id_caso=sivel2_gen_victimacolectiva.id_caso;
  ...
  def down
   execute <<-SQL
     ...
     UPDATE sivel2_gen_filiacion_victimacolectiva SET 
      ...
      FROM sivel2_gen_victimacolectiva WHERE 
        sivel2_gen_filiacion_victimacolectiva.victimacolectiva_id=sivel2_gen_victimacolectiva.id;

     ALTER TABLE sivel2_gen_filiacion_victimacolectiva 
      DROP COLUMN victimacolectiva_id;

     ALTER TABLE sivel2_gen_filiacion_victimacolectiva
      RENAME TO sivel2_gen_comunidad_filiacion ;
   SQL
  end
end
