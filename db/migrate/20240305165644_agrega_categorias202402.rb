class AgregaCategorias202402 < ActiveRecord::Migration[7.0]
  def up
    execute <<-SQL
      INSERT INTO public.sivel2_gen_categoria (id, nombre, fechacreacion, fechadeshabilitacion, id_pconsolidado, contadaen, tipocat, created_at, updated_at, observaciones, supracategoria_id) VALUES 
