...
--
-- Name: msip_tcentropoblado tipo_clase_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE INDEX msip_clase_id_municipio ON public.msip_centropoblado USING btree (municipio_id);
