...
CREATE VIEW public.cvt1 AS
 SELECT DISTINCT acto.id_caso,
  ...
  WHERE (((supracategoria.id_tviolencia)::text = 'B'::text) AND (categoria.id = ANY (ARRAY[427, 527, 526, 426, 55, 45, 40, 50, 46, 57, 49, 59, 501, 401, 402, 502, 522, 422, 425, 525, 424, 524, 43, 53, 423, 523, 48, 58, 41])));
