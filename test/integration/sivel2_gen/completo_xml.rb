  ...
  class PersonasXml < ActionDispatch::IntegrationTest
   ...
   PRUEBA_PROFESION= {
    ...
    test "Valida caso con 1 victima" do
       ...
       acto1= Sivel2Gen::Acto.create(id_presponsable:presponsable.id, id_categoria: categoria1.id, id_persona: persona1.id, id_caso: caso.id, created_at: "2019-01-01")
       acto2= Sivel2Gen::Acto.create(id_presponsable:presponsable.id, id_categoria: categoria2.id, id_persona: persona2.id, id_caso: caso.id, created_at: "2019-01-01")
       acto3= Sivel2Gen::Acto.create(id_presponsable:presponsable.id, id_categoria: categoria2.id, id_persona: persona3.id, id_caso: caso.id, created_at: "2019-01-01")
