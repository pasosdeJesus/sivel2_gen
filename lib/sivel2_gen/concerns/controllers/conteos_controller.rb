      ...
      module ConteosController
        ...
        included do
          ...
          def personas_arma_filtros_sivel2_gen
            caniosnac = Msip::Persona.where.not(anionac: nil)
          ...
          def personas_procesa_filtros(que1, tablas1, where1, que3,
            tablas3, where3)
            personas_procesa_filtros_sivel2_gen(
              que1,
              tablas1,
              where1,
              que3,
          ...
          def personas_vista_geo(que3, tablas3, where3)
            ...
            [
              "CREATE VIEW #{personas_cons2} AS SELECT #{personas_cons1}.*,
            ...
            @tablader = [
              {
                ...
                tablas: [
                  ...
                  genvic_tabla(
                    ...
                    "Total víctimizaciones por amenazas",
                    where1,
                  ),
              ...
              },
              {
                ...
                tablas: [
                  ...
                  genvic_tabla(
                    ...
                    "Total victimizaciones contra el derecho a la integridad",
                    where1,
                  ),
        ...
        class_methods do
          ...
          def genconsulta_victimizaciones(
            ...
            if pSegun && pSegun != ""
              ...
              when "SEXO"
                que1 += ", CASE  WHEN persona.sexo='#{Msip::Persona.convencion_sexo[:sexo_femenino]}' THEN '#{Msip::Persona.convencion_sexo[:nombre_femenino]}'   " \
                  "WHEN persona.sexo='#{Msip::Persona.convencion_sexo[:sexo_masculino]}' THEN '#{Msip::Persona.convencion_sexo[:nombre_masculino]}'   " \
