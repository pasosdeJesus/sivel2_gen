      ...
      module MapadepController
        ...
        included do
          ...
          def self.nomrango(fechaini, fechafin)
            ...
            mi = if fechaini.day == 1
              Msip::FormatoFechaHelper::MESES[fechaini.month]
            else
              "#{fechaini.day}/#{fechaini.month}"
            end
            mf = if fechafin.day == fechafin.end_of_month.day
              Msip::FormatoFechaHelper::MESES[fechafin.month]
            else
          ...
          def victimizaciones
            ...
            @mapadep_subtitulo = Sivel2Gen::MapadepController.nomrango(
              pFini != "" ? Msip::FormatoFechaHelper.reconoce_adivinando_locale(pFini) : Sivel2Gen::Caso.all.minimum(:fecha),
              pFfin != "" ? Msip::FormatoFechaHelper.reconoce_adivinando_locale(pFfin) : Sivel2Gen::Caso.all.maximum(:fecha),
            )
