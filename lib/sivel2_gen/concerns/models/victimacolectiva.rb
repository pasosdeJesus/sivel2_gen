        ...
        included do
          ...
          before_destroy do
            Sivel2Gen::Actocolectivo.where(
              caso_id: caso_id, grupoper_id: grupoper_id,
            ).delete_all
          end
          ...
          def importa(g, datossal, menserror, opciones = {})
            ...
            save!
            array_obs = []
            if g["observaciones"].is_a?(String)
            ...
            if array_obs
              array_obs.each do |ob|
                ...
                case ele[0]
                when "anotaciones"
                  grupoper.anotaciones = ele[1] if grupoper
                when "personasaprox"
