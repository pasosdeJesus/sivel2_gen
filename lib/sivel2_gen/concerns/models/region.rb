          ...
          def calcula_de_depmun(departamento_id, municipio_id)
            if departamento_id &&
              ...
              dr = Sivel2Gen::DepartamentoRegion
                .find_by(departamento_id: departamento_id)
              return dr.region
            end
            if municipio_id &&
              ...
              mr = Sivel2Gen::MunicipioRegion.find_by(
                municipio_id: municipio_id,
              )
              return mr.region
            end
            if municipio_id &&
              ...
              if Sivel2Gen::DepartamentoRegion.where(
                departamento_id: dm.departamento_id,
              ).count > 0
                dr = Sivel2Gen::DepartamentoRegion
                  .find_by(departamento_id: dm.departamento_id)
                return dr.region
              end
            end
